...
export class DetailCommandeComponent implements OnInit {
  ...
  commande = {} as Commande;
   ...
   constructor(private translate: TranslateService,public service: DataService,private dataService: ApiService,private routr: Router,private toastr: ToastrService, private dataservice:DataService, public router:ActivatedRoute) {
